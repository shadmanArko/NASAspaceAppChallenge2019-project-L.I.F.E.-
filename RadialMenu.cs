...
public class RadialMenu : MonoBehaviour
{
    ...
    private void SetSectionRotation(float newRotation)
    {
    ...
    {
        return GetNearestIncreament(rotation) * degreeIncrement;
    }

    private int GetNearestIncreament(float rotation)
    {
        return Mathf.RoundToInt(rotation / degreeIncrement);
    }

    private void SetSelectionEvent(float currentRotaion)
    {
        int index = GetNearestIncreament(currentRotaion);
